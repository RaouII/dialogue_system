##
## THIS IS AN OLD VERSION OF THE DIALOGUE SCRIPT, IT USED TO HANDLE BOTH UI AND DIALOGUE LOGIC BEFORE I SPLIT IT IN TWO
##
extends Node
...
func show_responses(_topic: DialogueTopic):
	...
	if _topic._random:
		...
		set_character_idle_animation.emit(_response.character_id, _response._idleAnimation)
